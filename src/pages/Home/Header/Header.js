...
import logo from '../../../image/header_logo_one.svg'
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              ...
              <div className="hidden md:block">
                <div className="ml-40 flex items-baseline space-x-10">
                 <Link to="/home" className=" hover:bg-gray-700 text-white px-3 py-2 rounded-md text-2xl font-medium">Home</Link>
